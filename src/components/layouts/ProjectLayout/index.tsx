            ...
            <main id="main" className="sb-layout sb-project-layout">
                <article className="px-4 py-14 lg:py-20">
                    <div className="max-w-5xl mx-auto">
                        ...
                        {description && <div className="text-xl leading-normal uppercase mx-auto mb-10 sm:mb-16">{description}</div>}
                        {media && (
                        ...
                        {markdownContent && (
                            <Markdown options={{ forceBlock: true, overrides: { pre: HighlightedPreBlock } }} className="sb-markdown mx-auto">
                                {markdownContent}
                            </Markdown>
                        )}
                    </div>
